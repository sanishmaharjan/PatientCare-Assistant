...
class MedicalRetriever:
    ...
    def get_patient_documents(self, patient_id: str, top_k: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Error searching by patient ID: {e}")
        
        # If no exact matches or error, try semantic search
        query = f"Information about patient {patient_id}"
        return self.query_by_text(query, top_k)
